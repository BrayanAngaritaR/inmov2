         ...
         <div class="nk-content-body">
                     ...
                     <div class="modal-body modal-body-lg">
                        ...
                        <form action="{{ route('panel.users.update') }}" method="POST">
                           ...
                           <div class="row gy-4">
                              ...
                              <div class="col-md-6">
                                 <div class="form-group">
                                    <label class="form-label" for="phone-no">Número de contacto</label>
                                    <input type="text" class="form-control form-control-lg" id="phone" name="phone" @if($user_info) value="{{ $user_info->phone }}" @endif placeholder="Número de contacto" />
                                 </div>
                              </div>
                              <div class="col-md-6">
                                 <div class="form-group">
                                    <label class="form-label" for="birth-day">Fecha de creación</label>
                                    <input type="text" class="form-control form-control-lg date-picker" id="birth-day" disabled value="{{ $user->created_at->format('m/d/Y') }}" placeholder="Ingresa tu fecha de nacimiento" />
                                 </div>
                              </div>
                              <div class="col-md-6">
                                 <div class="form-group">
                                    <label class="form-label" for="birth-day">Dependencia</label>
                              ...
                              <div class="col-md-6">
                                 <div class="form-group">
                                    <label class="form-label" for="phone-no">Cargo</label><input type="text" class="form-control form-control-lg" name="position" @if($user_info) value="{{ $user_info->position }}" @endif />
                                 </div>
                              </div>
                              <div class="col-12">
            ...
            <div class="nk-block">
               ...
               <div class="nk-data data-list">
                  ...
                  <div class="data-item" data-bs-toggle="modal" data-bs-target="#profile-edit">
                     <div class="data-col"><span class="data-label">Número de contacto</span><span class="data-value text-soft">@if($user_info){{ $user_info->phone }} @else 0 @endif</span></div>
                     <div class="data-col data-col-end">
                        <span class="data-more"><em class="icon ni ni-forward-ios"></em></span>
                     </div>
                  </div>
                  <div class="data-item" data-bs-toggle="modal" data-bs-target="#profile-edit">
                     <div class="data-col"><span class="data-label">Dependencia</span><span class="data-value">@if($user_info){{ $user_info->dependency->title }} @else No definida @endif</span></div>
                     <div class="data-col data-col-end">
                        <span class="data-more"><em class="icon ni ni-forward-ios"></em></span>
                     </div>
                  </div>
                  <div class="data-item" data-bs-toggle="modal" data-bs-target="#profile-edit">
                     <div class="data-col"><span class="data-label">Profesión</span><span class="data-value">@if($user_info){{ $user_info->position }} @else No definida @endif</span></div>
                     <div class="data-col data-col-end">
                        <span class="data-more"><em class="icon ni ni-forward-ios"></em></span>
                     </div>
                  </div>
