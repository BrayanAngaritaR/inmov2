(function ($) {
    ...
    function mainMap() {
        function locationData(locationURL, locationCategory, locationImg, locationTitle, locationAddress,     locationPrice , locationStatus) {
		 ...
		 //   locations ------------------
        var locations = [
            [locationData('listing-single2.html', 'Apartment', 'images/all/3.jpg', 'Gorgeous house for sale', "70 Bright St New York, USA",  "600.000" , "Sale"), 6.256635, -75.568413611111, 0, markerIcon],
            [locationData('listing-single.html', 'Apartment', 'images/all/1.jpg', 'Luxury Family Home', "40 Journal Square  , NJ, USA",  "320.000" , "Sale"), 6.2529777777778, -75.573136111111, 1, markerIcon],
            [locationData('listing-single.html', 'House', 'images/all/9.jpg', 'Family house for Rent', "34-42 Montgomery St , NY, USA",    "700 / per month" , "Rent"), 6.2559216666667, -75.558384166667, 2, markerIcon],
            [locationData('listing-single.html', 'House', 'images/all/6.jpg', 'Contemporary Apartment', "W 85th St, New York, USA",   "1,600.000" , "Sale"), 6.2666288888889, -75.542650555556, 3, markerIcon],
            [locationData('listing-single.html', 'Villa', 'images/all/5.jpg', 'Kayak Point House', "75 Prince St, NY, USA",   "500.000" , "Sale"), 6.2666083333333, -75.542813888889, 4, markerIcon],
            [locationData('listing-single.html', 'Apartment', 'images/all/8.jpg', ' Urban House', "70 Bright St, Jersey City, NJ USA",   "1500 / per month" , "Rent"), 6.2665583333333, -74.15737152, 5, markerIcon],
            [locationData('listing-single.html', 'Apartment', 'images/all/4.jpg', 'Park Avenue apartment', "123 School St. Lynchburg, NY ",   "1000 / per month" , "Rent"), 40.79145927, -75.542791666667, 6, markerIcon],
            [locationData('listing-single2.html', 'Hotel', 'images/all/25.jpg', 'Fancy Hotel', "Mt Carmel Pl, New York, NY",     "1.200.000" , "Sale"), 6.29298, -75.586060555556, 7, markerIcon],
            [locationData('listing-single2.html', 'Office', 'images/all/7.jpg', 'New York Office Center', "1-30 Hunters Point Ave, Long Island City, NY",     "510 / per month" , "Rent"), 6.2573413888889, -75.567134166667, 8, markerIcon],
        ];
	    //   Map Infoboxes end ------------------
        var map = new google.maps.Map(document.getElementById('map-main'), {
            zoom: 10,
            scrollwheel: false,
            center: new google.maps.LatLng(6.23, -75.62),
