@extends('panel.app') 
@section('content') 
@section('title', 'Auditorías para el bien ' . $property->code) 
@section('subtitle', 'Estas son las auditorías para ' . $property->code)
            ...
            <div class="add-listing-headline">
               <div class="nk-tb-list is-separate mb-3">
                  <div class="nk-tb-item nk-tb-head">
                     ...
                     <div class="nk-tb-col tb-col-mb"><span class="sub-text">Usuario</span></div>
                  ...
                  <div class="nk-tb-item">
                     <div class="nk-tb-col tb-col-lg">
                        <span class="tb-amount">No hay auditorías para este bien</span>
                     </div>
                  </div>
                  @endforelse
               </div>
