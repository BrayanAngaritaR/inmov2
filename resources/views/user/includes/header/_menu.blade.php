		...
		<ul id="responsive">
			...
			<li><a href="#">User Panel</a>
				<ul>
					...
					<li><a href="{{ route('panel.properties.create') }}">Agregar inmueble</a></li>
...
<div class="right-side">
	...
	<div class="header-widget">
		...
		@else
		<a href="{{ route('logout') }}" class="sign-in popup-with-zoom-anim" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
			<i class="sl sl-icon-power"></i> Cerrar sesión
		</a>
		...
		<!-- User Menu -->
		{{-- <div class="user-menu">
			<div class="user-name"><span><img src="https://www.vasterad.com/themes/listeo/images/dashboard-avatar.jpg" alt=""></span>Hi, Tom!</div>
			<ul>
		...
		@auth
		<a href="{{ route('panel.properties.create') }}" class="button border with-icon">Agregar inmueble <i class="sl sl-icon-plus"></i></a>
		@endauth
	</div>
	<!-- Header Widget / End -->
</div>
