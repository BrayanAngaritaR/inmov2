...
@section('content')
         ...
         <div class="custom-form fl-wrap">
            <div class="row">
               ...
               <div class="col-sm-4 col-lg-2">
                  <div class="listsearch-input-item">
                     <select data-placeholder="Status" class="chosen-select on-radius no-search-select" id="action">
                        <option disabled selected>Destinación actual</option>
                        <option>Todas</option>
                     </select>
                  </div>
               </div>
               ...
               <div class="col-sm-4 col-lg-2">
                  <div class="listsearch-input-item">
                     <select data-placeholder="Status" class="chosen-select on-radius no-search-select" id="action">
                        <option disabled selected>Oportunidad</option>
               ...
               <div class="col-sm-4 col-lg-2">
                  <div class="listsearch-input-item">
                     <select data-placeholder="Status" class="chosen-select on-radius no-search-select" id="area">
                        ...
                        <option>0 - 500 m2/ft2</option>
                        <option>500 - 1500 m2/ft2</option>
                        <option>1500 - 5000 m2/ft2</option>
                        <option>+5000 m2/ft2</option>
   ...
   <div class="col-list-wrap gray-bg">
      ...
      <div class="fl-wrap">
         <div class="col-list-wrap_opt_btn color-bg">Ver filtros</div>
         <div class="show-hidden-map not-vis_lap col-list-wrap_opt_btn color-bg">Mostrar mapa</div>
      </div>
      ...
      <div class="container mt-5">
         <div class="more-opt_btn mor-opt-btn_act">Búsqueda avanzada<span><i class="fas fa-caret-down"></i></span></div>
                        <!-- more-search-opt-wrap -->
                        <div class="more-search-opt-wrap more-hidden_wrap">
                            <div class="msotw_title fl-wrap"><i class="far fa-sliders-h"></i>Búsqueda avanzada</div>
                            <div class="close_msotw"><i class="fal fa-times"></i></div>
                            <div class="clearfix"></div>
                            <div class="row">
                                <!-- listsearch-input-item -->                      
                                <div class="col-sm-3">
                                    <div class="listsearch-input-item">
                                        ...
                                        <select data-placeholder="Macroproyecto" class="chosen-select on-radius no-search-select" >
                                            <option>Todos</option>
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="listsearch-input-item clact">
                                ...
                                <div class=" fl-wrap filter-tags">
                                    <ul class="no-list-style">
                                        <li>
                                            <input id="check-aa" type="checkbox" name="check">
                                            <label for="check-aa">Comodato</label>
                                        </li>
                                        <li>
                                            <input id="check-b" type="checkbox" name="check">
                                            <label for="check-b"> BIC</label>
                                        </li>
                                        <li>   
                                            <input id="check-d8" type="checkbox" name="check">
                                            <label for="check-d8">Proyecto gestionado</label>
                                        </li>

                                        <li>   
                                            <input id="check-d8" type="checkbox" name="check">
                                            <label for="check-d8">Es RPH</label>
                                        </li>
                                    </ul>
                                </div>
                            </div>
