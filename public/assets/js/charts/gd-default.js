...
!function (NioApp, $) {
  ...
  var salesRevenue = {
    ...
    datasets: [{
      ...
      //@v2.0
      data: [5500, 9500, 14299, 11000]
    }]
  };

  var salesRevenue2 = {
    labels: ["Institucionales 1", "Institucionales 2", "Institucionales 3", "Institucionales 4", "Institucionales 5", "Institucionales 6", "Institucionales 7", "Institucionales 8"],
    dataUnit: 'USD',
    stacked: true,
    datasets: [{
      label: "Sales Revenue",
      color: [NioApp.hexRGB("#6576ff", .2), NioApp.hexRGB("#6576ff", .2), NioApp.hexRGB("#6576ff", .2), NioApp.hexRGB("#6576ff", .2), NioApp.hexRGB("#6576ff", .2), NioApp.hexRGB("#6576ff", .2), NioApp.hexRGB("#6576ff", .2), NioApp.hexRGB("#6576ff", .2), NioApp.hexRGB("#6576ff", .2), NioApp.hexRGB("#6576ff", .2), NioApp.hexRGB("#6576ff", .2), "#6576ff"],
      //@v2.0
      data: [11000, 8000, 12500, 5500, 9500, 14299, 11000, 8000]
    }]
  };
  ...
  var salesRevenue3 = {
    ...
    datasets: [{
      ...
      color: [NioApp.hexRGB("#6576ff", .2), NioApp.hexRGB("#6576ff", .2), NioApp.hexRGB("#6576ff", .2), NioApp.hexRGB("#6576ff", .2), NioApp.hexRGB("#6576ff", .2), NioApp.hexRGB("#6576ff", .2), NioApp.hexRGB("#6576ff", .2), NioApp.hexRGB("#6576ff", .2), NioApp.hexRGB("#6576ff", .2), NioApp.hexRGB("#6576ff", .2), NioApp.hexRGB("#6576ff", .2), "#6576ff"],
      //@v2.0
      data: [8000, 12500, 5500, 9500, 14299]
    }]
  };
